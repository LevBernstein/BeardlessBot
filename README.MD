...
discord.com/api/oauth2/authorize?client_id=654133911558946837&permissions=8&scope=bot

### Dependencies:

* Python 3. To install, visit python.org/downloads/ and follow the instructions for your OS.
