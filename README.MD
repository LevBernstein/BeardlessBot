...
3. Place token.txt in the resources folder.

4. Create a filed named "catToken.txt" that contains your Cat API token (you can get a token [here](https://thecatapi.com/)).

5. Place catToken.txt in the resources folder.
