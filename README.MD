...
6. Create a file named "dogToken.txt" that contains your Dog API token (you can get a token [here](https://thedogapi.com/signup/)).

7. Place all three token files in the resources folder.
